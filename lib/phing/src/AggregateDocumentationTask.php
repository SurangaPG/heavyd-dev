...
class AggregateDocumentationTask extends Task {
  ...
  public function main() {
    ...
    $html = $this->aggregateSourceFiles($this->getSourceDir());
   ...
   */
  public function aggregateSourceFiles($dir) {
    ...
    // Move the title if such a component exists.
    $partials['_title'] = 'Untitled';
    if (isset($partials['html']['_title'])) {
      $partials['title'] = $partials['html']['_title'];
      unset($partials['html']['_title']);
    }
    ...
    return $this->twigEnv->render('page.html.twig', $partials);
  }
